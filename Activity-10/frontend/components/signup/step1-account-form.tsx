...
import { Mail, Lock, Eye, EyeOff, HelpCircle, Check, XCircle, Loader2 } from "lucide-react";
    ...
    return (
        ...
        >
            <motion.div
                ...
                transition={{ duration: 0.2, ease: "easeOut" }}
            >
                <label htmlFor="email" className="block text-xs xs:text-sm font-medium text-neutral-900 dark:text-white/90 mb-1.5 xs:mb-2">
                    Email
                </label>
            ...
            >
                <label htmlFor="password" className="block text-xs xs:text-sm font-medium text-neutral-900 dark:text-white/90 mb-1.5 xs:mb-2">
                    Password
                </label>
                <div className="relative">
                    ...
                    <div className="absolute right-2.5 xs:right-3 top-1/2 -translate-y-1/2 flex items-center gap-1.5">
                        ...
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <button
                                    type="button"
                                    className="text-neutral-500 dark:text-white/50 hover:text-neutral-700 dark:hover:text-white transition-colors"
                                >
            ...
            >
                <label htmlFor="confirmPassword" className="block text-xs xs:text-sm font-medium text-neutral-900 dark:text-white/90 mb-1.5 xs:mb-2">
                    Confirm Password
                </label>
                <div className="relative">
                    <Lock className="absolute left-2.5 xs:left-3 top-1/2 -translate-y-1/2 w-4 h-4 xs:w-5 xs:h-5 text-neutral-500 dark:text-white/50" />
